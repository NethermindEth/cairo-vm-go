		...
		"Blake2sAddUint256": {
			{
				...
				makeHinter: func(ctx *hintTestContext) hinter.Hinter {
					return newBlake2sAddUint256Hint(ctx.operanders["low"], ctx.operanders["high"], ctx.operanders["data1"])
				},
				check: allVarAddrResolvedValueEquals(map[string]*fp.Element{
					"data1": feltString("4294967264"),
					"data2": feltString("4294967295"),
					"data3": feltString("4294967295"),
					"data4": feltString("4294967295"),
					"data5": feltString("4294967295"),
					"data6": feltString("4294967295"),
					"data7": feltString("4294966768"),
					"data8": feltString("134217727"),
				}),
			},
			{
				// 2**256
			...
			},
			{
				...
				check: allVarAddrResolvedValueEquals(map[string]*fp.Element{
					"data1": feltString("2147483649"),
					"data2": feltString("4294967151"),
					"data3": feltString("1140850687"),
					"data4": feltString("0"),
					"data5": feltString("4292870144"),
					"data6": feltString("4294967295"),
					"data7": feltString("2147483664"),
					"data8": feltString("134215271"),
				}),
			},
			{
				// 689
