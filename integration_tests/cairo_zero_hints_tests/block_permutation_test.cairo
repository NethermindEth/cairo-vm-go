// cairo-compile block_permutation_test.cairo --proof_mode --output compiled.json
// cairo-run --program=compiled.json --layout starknet --print_memory (--print_output)
// layouts : 'plain', 'small', 'dex', 'recursive', 'starknet', 'recursive_large_output', 'all_solidity', 'starknet_with_keccak'
